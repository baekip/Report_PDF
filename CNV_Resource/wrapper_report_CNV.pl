...
my $template_resource_path = "$dev_path/wes/CNV_Resource/PDF_resource"; ###
...
my $script_30 = $script_path."/30.parse_cna_summary.pl";
checkFile ($script_30);

my $script_31 = $script_path."/31.parse_cna_plot.pl";
checkFile($script_31);
...
run_script ( $script_24, $general_config_file, $pipeline_config_file, "$resource_path/3-2. Somatic_Information/3.2.5 c_table_01.txt");
...
run_script ( $script_30, $general_config_file, $pipeline_config_file, "$resource_path/3-3_CNA_Information/1_b_table_01.txt");

run_script ( $script_31, $general_config_file, $pipeline_config_file, "$resource_path/3-3_CNA_Information/2_b_photoMap_01.txt");
