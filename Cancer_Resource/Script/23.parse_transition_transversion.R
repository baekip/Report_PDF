...
Alignment_ratio<-cbind(Alignment, Alignment$value / as.numeric(Alignment$Total))
names(Alignment_ratio)[5] <-"Rate"


#png ( output_png, width=2200, height=1200, res=480)
CairoPNG (output_png, width=2200, height=1200, res=480)

ggplot(data=Alignment_ratio, aes(x=Temporary.ID, y=Rate, fill=variable)) + 
